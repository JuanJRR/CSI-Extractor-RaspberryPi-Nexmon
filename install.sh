...
cd "/home/csi/" # best way to ensure this is a Pi lol

mkdir -p "/home/csi/.picsi/bins/" && cd "$_"
...
if ! wget "https://github.com/JuanJRR/CSI-Extractor-RaspberryPi-Nexmon/tree/main/base/$KERNEL_VERSION.tar.xz"; then
